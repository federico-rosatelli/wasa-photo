...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/profile/:id/image/like/:imageid", rt.AddLikeProfile)
	rt.router.DELETE("/profile/:id/image/like/:imageId", rt.DeleteLikeProfile)
	rt.router.POST("/profile/:id/iamge/comment/:imageId", rt.AddCommentProfile)
	rt.router.DELETE("/profile/:id/image/comment/:imageId", rt.DeleteCommentProfile)
