...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.POST("/profile/:id/image/:imageid/like", rt.AddLikeProfile)
	rt.router.DELETE("/profile/:id/image/:imageId/like", rt.DeleteLikeProfile)
	rt.router.POST("/profile/:id/iamge/:imageId/comment", rt.AddCommentProfile)
	rt.router.DELETE("/profile/:id/image/:imageId/comment", rt.DeleteCommentProfile)
